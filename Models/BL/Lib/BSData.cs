    ...
    public class BSData
    {
        ...
        public static InitForBeamDiagram LoadForBeamDiagram()
        {
            try
            {
                ...
                using (SQLiteConnection cnn = new SQLiteConnection(LoadConnectionString()))
                {
                    IEnumerable<InitForBeamDiagram> output = (IEnumerable<InitForBeamDiagram>)cnn.Query<InitForBeamDiagram>(query, new DynamicParameters());
        ...
        public static List<Elements> LoadFiberConcreteTable(string _iB = "")
        {
            try
            {
                using (SQLiteConnection cnn = new SQLiteConnection(LoadConnectionString()))
                {
                    ...
                    IEnumerable<Elements> output = (IEnumerable<Elements>)cnn.Query<Elements>(query, new DynamicParameters());
                    return output.ToList();
                }
            }
            catch (Exception _e)
